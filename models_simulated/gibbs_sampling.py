...
def prepare_experiment_data(alleles_count, population_amount, alpha_val):
    ...
    return observed, elapsed_initial_time
...
def perform_experiment(alleles_count,
    ...
    if plot_index >= 0:
        ...
        # plt.xlabel('Time')
        # plt.ylabel('ln(p_i)')
        # plt.title(f'Alleles: {alleles_count}. Population: {population_amount_calculated}')
    # print(observed)
    # print(observed_cdf)
...
def full_algorithm(observations):
    ...
    return mean_result, elapsed_time
...
if __name__ == "__main__":
    ...
    p_val = perform_experiment(alleles_count_, population_amount_calculated_, alleles_probabilities_, probabilities_,
                               observed_, observed_cdf_, plot_index=0)
    print(p_val)
