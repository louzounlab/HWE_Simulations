...
def run_experiment(alleles_count, population_amount, alpha_val, uncertainty_val,
    ...
    plt.scatter(correction_vector, variance_no_sampling_vector, color='black', s=1.5)
    plt.xlabel('E(m,n)*Corr(m,n)')
    plt.ylabel('VAR NO SAMPLING')
    ...
    for alpha in alpha_vals:
        for uncertainty in uncertainty_vals:
            ...
            run_experiment(alleles_count=alleles_amount,
                           ...
                           plot_index=plot_num)
    plt.savefig('correction_vs_variance_no_sampling.png', pad_inches=0.2, bbox_inches="tight")
    plt.show()