...
def get_data_for_chi_squared():
    ...
    df_old_chi_squared_results.to_csv(f'{real_data_path}/results/old_chi_squared_p_values.csv')
    df_new_chi_squared_results.to_csv(f'{real_data_path}/results/new_chi_squared_p_values.csv')
    df_old_chi_squared.to_csv(f'{real_data_path}/results/old_chi_squared_statistic.csv')
    df_new_chi_squared.to_csv(f'{real_data_path}/results/new_chi_squared_statistic.csv')
    # df_ambiguities.to_csv(f'{real_data_path}/results/ambiguities')
    df_dof.to_csv(f'{real_data_path}/results/dof.csv')
...
def perform_tests_save_data(level, race):
    ...
    old_p_value, old_chi_squared, old_dof = chi_squared.run_experiment(alleles_count=alleles_count,
    ...
    print('new test')
    new_p_value, new_chi_squared, new_dof = chi_squared.run_experiment(alleles_count=alleles_count,
                                                                       population_amount=population_amount,
                                                                       alleles_probabilities=alleles_probabilities,
                                                                       observed_probabilities=observed_probabilities,
                                                                       correction=correction,
    ...
    return old_p_value, new_p_value, old_chi_squared, new_chi_squared, new_dof
